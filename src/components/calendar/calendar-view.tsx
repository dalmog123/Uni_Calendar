...
export function CalendarView() {
  // All the existing code from page.tsx, just changing the component name from 'Component' to 'CalendarView'
  ...
  // Copy everything else from the original Component, keeping the same implementation
